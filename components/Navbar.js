...
export default function Navbar() {
  ...
  // Operaio: navbar minimale senza link di navigazione
  if (isOperaio) {
    return (
      <nav className="bg-gray-950 text-white shadow-lg sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 flex items-center justify-between h-14">
          <div className="flex items-center gap-3 shrink-0">
            <Image src="/logo.png" alt="FC Costruzioni" width={32} height={32} className="rounded" />
  ...
  const links = [
    ...
    { href: "/presenze", label: "Presenze", show: isAdmin || isUfficio || isInserimento },
    { href: "/totali", label: "Tot. Presenze", show: isAdmin || isUfficio || isInserimento },
    { href: "/rapportini", label: "Rapportini", show: isAdmin || isUfficio || isInserimento },
    { href: "/rimborsi", label: "Rimborsi", show: isAdmin || isUfficio || isInserimento },
    ...
    { href: "/dipendenti", label: "Dipendenti", show: isAdmin || isUfficio },
    { href: "/cantieri", label: "Cantieri", show: isAdmin || isUfficio },
