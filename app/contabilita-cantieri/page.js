            ...
            <table className="w-full min-w-[1100px]">
              <thead>
                <tr className="border-b bg-gray-50 text-xs font-medium text-gray-600">
                  <th className="sticky-col-head text-left px-4 py-3 min-w-[200px]">Nome e Cognome</th>
                ...
                {rows.map((r, i) => {
                  ...
                  return (
                    <tr key={r.employeeId} className={`border-b last:border-0 ${i % 2 === 0 ? "" : "bg-gray-50/50"}`}>
                      <td className="sticky-col px-4 py-3 font-medium text-gray-900">{r.fullName}</td>
